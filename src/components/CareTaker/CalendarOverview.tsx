        ...
        <div className="grid grid-cols-7 gap-2">
          {Array.from({ length: daysInMonth }).map((_, i) => {
            ...
            return (
              <div
                key={i}
                className={`h-20 flex flex-col items-center justify-start rounded-md p-1 text-sm cursor-pointer border ${
              ...
              >
                <div className="w-full text-center font-medium mb-1">{i + 1}</div>
